...
CodeWire is in private beta. You need an **invite code** to sign up.
...
CodeWire provisions a dedicated Coder deployment for you. This typically takes **2-5 minutes**.
...
1. Click **Open Coder** to go to your Coder dashboard at `your-slug.codewire.sh`
