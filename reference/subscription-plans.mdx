...
Codespace uses per-resource billing. Each resource in your organization has its own subscription.
...
All plans include seat-based pricing at **$18 per developer per month** for workspace usage.
