...
2. Fill in the form:
   - **Invite code** — provided by your organization or Codespace
...
Once your email is verified, [sign in](/getting-started/sign-in) and [create your first resource](/getting-started/create-your-first-resource).
