...
Codespace provides several security features to protect your account.
...
1. Go to [Settings → Security](https://codespace.sh/settings/security)
...
1. Go to [Settings → Sessions](https://codespace.sh/settings/sessions)
...
From [Settings → Account](https://codespace.sh/settings/account):

### Export your data

Download a JSON file containing your profile, sessions, memberships, instances, and audit logs.

### Delete your account

<Warning>
  Account deletion is permanent after the grace period. All your instances, workspaces, and data will be destroyed.
</Warning>

1. Click **Delete Account**
2. Review what will be deleted:
   - All Coder instances you own
