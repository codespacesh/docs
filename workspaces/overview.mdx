...
Workspaces are created from the **Coder dashboard** (your instance at `subdomain.codewire.sh`), not from the CodeWire dashboard. Each instance comes with pre-configured templates.
...
The CodeWire dashboard shows all workspaces across your Coder instance in the **Workspaces** tab on the resource detail page. From there you can:
