...
A **resource** is a fully managed service provisioned by CodeWire within your organization. Each resource has its own infrastructure, domain, and configuration.
